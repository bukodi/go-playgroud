...
func AcquireCredentials(username string) (*Credentials, SECURITY_STATUS, error) {
	var h CredHandle
	s := AcquireCredentialsHandle(nil, syscall.StringToUTF16Ptr("Kerberos"),
...
func main() {
	//proxyURL := "https://mzsw7appldev:8443/Margareta-EE-Migr/EEAppletMigrServiceProxy?wsdl"
	proxyURL := "https://noreg-nb33.noreg.intra:1113/debug"
